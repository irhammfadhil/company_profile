            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/">Product</a><i class="fa fa-angle-double-right"></i><span>Product Specification</span>
                    ...
                    <div class="text-container">
                        <table class="table">
                            <tr>
                                ...
                                <td>{{$query[0]->purity}}%</td>
                            </tr>
                            <tr>
                                <th scope="col">Element Purity</th>
                                <td>{{$query[0]->element_purity}}%</td>
                            </tr>
                            <tr>
