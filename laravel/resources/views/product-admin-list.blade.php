            ...
            <div class="col-lg-12">
                ...
                <table class="table table-hover table-borderless" id="laravel">
                   ...
                   <tbody>
                    ...
                    <tr>
                        <td><a href="/specs?id={{$p->product_id}}">{{$p->product_name}}</td>
                        ...
                        <td><p><a class="btn btn-warning" href="product_list/edit/{{$p->product_id}}" role="button">Edit</a></p>
                        <p><a class="btn btn-warning" href="product_list/details/edit/{{$p->product_id}}" role="button">Edit Details</a></p>
                        <p><form method="get" action="product_list/delete/{{$p->product_id}}">
                        @csrf
