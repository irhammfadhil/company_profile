...
Route::get('product_list/details/edit/{id}', 'App\Http\Controllers\ProductController@showFormUpdateSpecs')->middleware('auth');

Route::post('/product_list/details/edit/proses/{id}', 'App\Http\Controllers\ProductController@updateDetails')->middleware('auth');